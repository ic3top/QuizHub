...
**Експерт -** це фізична особа, яка має високу кваліфікацію, спеціальні знання і безпосередньо здійснює наукову чи науково-технічну експертизу та несуть персональну відповідальність за достовірність і повноту аналізу, обгрунтованість рекомендацій відповідно до вимог завдання на проведення експертизи.
...
Експертний метод оцінювання —  це один з різновидів опитування. Відрізняє його від масового опитування те, що респондентами є найкомпетентніші у досліджуваній сфері особи, тобто експерти.
...
Google Форми  — програмне забезпечення для адміністрування опитування, що входить до складу безкоштовного веб-пакету Google Docs Editors, пропонованого Google. Додаток дозволяє користувачам створювати та редагувати опитування в Інтернеті, співпрацюючи з іншими користувачами в режимі реального часу.

### SurveyMonkey

SurveyMonkey - один із найпопулярніших онлайн-сервісів для проведення опитувань. З його допомогою можна отримувати інформацію про цільову аудиторію, визначати ступінь задоволеності клієнтів товарами та послугами. 

### Survio

Survio — це сервіс, що дозволяє за два кроки створити опитування або анкету, вставити в них зображення або кліпи, доповнити сучасним стилем, внести інтерактивні графіки. Також включає в себе інструменти для поширення і повного аналізу відповідей, зібраних під час опитування.

### SurveyJS

SurveyJS - безкоштовна бібліотека веб-розробок з відкритим вихідним кодом для веб-додатків статистичних опитувань, написаних на JavaScript. Бібліотека підтримує кілька популярних фреймворків, включаючи React.js, Angular 2, Vue.js.  
...
| Критерії/сервіси | Google Forms | SurveyMonkey | Survio | SurveyJS | Система “ОСА” | QuizHub |
| :------: |:------------:| :-----:|:-----: |:-----: |:-----: |:-----: |
| Мова інтерфейсу | UKR/ENG/RUS | ENG/RUS | ENG/RUS | ENG | UKR/RUS | ENG |
